...
import 'package:neigbours_intercom_service/core/widgets/responsive_tab_bar.dart';
...
import 'package:neigbours_intercom_service/intercom/tabs/gatekeepers_tab.dart';
import 'package:neigbours_intercom_service/intercom/tabs/posts_tab.dart';
import 'package:neigbours_intercom_service/intercom/tabs/society_office_tab.dart';
import 'package:neigbours_intercom_service/intercom/tabs/lobbies_tab.dart';
import 'package:neigbours_intercom_service/intercom/tabs/groups_tab.dart';
import 'package:neigbours_intercom_service/models/call_history_entry.dart';
import 'package:neigbours_intercom_service/models/call_status.dart';
...
import 'package:neigbours_intercom_service/services/call_history_service.dart';
...
import 'package:neigbours_intercom_service/intercom/utils/activity_preview_helper.dart';
import 'package:neigbours_intercom_service/intercom/chat_screen.dart';
...
class IntercomScreen extends StatefulWidget {
  ...
  /// Host-defined call/video toggles (from monorepo `GuardIntercomConfig`).
  final GuardIntercomConfig guardConfig;
  ...
  const IntercomScreen({
    ...
    this.guardConfig = const GuardIntercomConfig(),
  }) : super(key: key);
...
class _IntercomScreenState extends State<IntercomScreen>
  ...
  void initState() {
    ...
    if (kDebugMode) {
      developer.log(
        'IntercomScreen guardConfig: calls=${widget.guardConfig.callsEnabled} '
        'video=${widget.guardConfig.videoEnabled}',
      );
    }
    _initializeTabs();
